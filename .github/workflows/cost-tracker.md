...
source: githubnext/agentics/workflows/cost-tracker.md@c7d030cd6d4607b90d9ac3ffc8b24aff4f251632
---
...
Cost per model = (input*tokens * input*rate + output_tokens * output*rate + cache_creation_input_tokens * cache*write_rate + cache_read_input_tokens * cache_read_rate) / 1_000_000
...
_Data from [token-usage.jsonl](https://github.github.com/gh-aw/reference/token-usage/) written by gh-aw's firewall._
```
