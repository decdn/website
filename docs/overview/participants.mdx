---
title: Participants
description: Who does what, who bonds, who pays, and who is on- or off-protocol.
---
...
- **Bond.** A capacity bond in TOKEN, scaled to declared bandwidth (`bond = k × Mbps^α`) — the only TOKEN-side requirement to join the mesh; there is no flat minimum stake.
