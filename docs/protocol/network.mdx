...
description: A flat mesh of staked nodes — gossip on regional and global topics for node discovery, a Kademlia-subset DHT for content, and on-chain registration.
---
