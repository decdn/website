---
title: Payments
description: Clients pay nodes per MB over off-chain USDC payment channels with on-chain settlement, at market-driven rates inside governance-set bounds.
---
