---
title: Reputation
description: Nodes are scored 0.0–1.0 from local delivery outcomes plus weighted gossip from staked peers, with per-report clamps, decay, and a cold-start bonus.
---
