---
title: Governance
description: Operator governance weighted by delivered bytes, with safety bounds and a partially-sunsetted emergency multisig.
---
